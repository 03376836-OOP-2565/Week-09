...
```
![image](https://github.com/PiyatidaPh/Week-09/assets/115066285/add62fe0-ac0a-4b0b-bfc6-fc245231dfc4)
...
```
![image](https://github.com/PiyatidaPh/Week-09/assets/115066285/1efd9f9b-3394-4da5-9a2d-3298a571fd3e)
...
```
![image](https://github.com/PiyatidaPh/Week-09/assets/115066285/d2861591-4e93-4bca-b00f-076f3279cf07)
...
```
![image](https://github.com/PiyatidaPh/Week-09/assets/115066285/3870a215-9924-4c52-aaa5-1d42bc633349)
...
```
![image](https://github.com/PiyatidaPh/Week-09/assets/115066285/e0e87af6-8d49-4edf-991b-b0227384eb00)

## คำถาม

1. ท่านคิดว่าวิธีการทำ constructor overloading แล้วเรียกต่อกันเป็นทอดๆ จะช่วยอำนวยความสะดวกอะไรในการเขียนโปรแกรมของท่าน
```
 ช่วยให้โปรแกรมทำงานได้มีประสิทธิภาพมากขึ้นโดยสามารถรับค่าที่หลากหลายได้และไม่ error หากรับค่ามากเกินที่กำหนดแต่แลกมาด้วยความที่โปรแกรมอาจจะช้าเนื่องจากต้องรันโค้ดหลายบรรทัดมาก
```
